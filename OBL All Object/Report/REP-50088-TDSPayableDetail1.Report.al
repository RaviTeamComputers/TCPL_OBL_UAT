report 50088 "TDS Payable Detail.1"
{
    ...
    dataset
    {
        dataitem("TDS Entry"; "TDS Entry")
        {
            ...
            column(TotalTDS; "TDS Amount")
            {
            }
            column(Pan; Pan)
            {
            }
            column(TDSSection; "TDS Entry".Section) // 16630 replace here TDS Section
            {
            }

            trigger OnAfterGetRecord()
            var
                PSCM_Loc: Record "Sales Cr.Memo Header";
            begin
                ...
                IF ("Document Type" <> "Document Type"::"Credit Memo") THEN begin
                    ...
                    if PSCM_Loc.Get("Document No.") then begin
                        IF Customer.GET(PSCM_Loc."Sell-to Customer No.") THEN BEGIN
                            Perticulars := Customer.Name;
                            Pan := Customer."P.A.N. No.";
                        END;
                    end;
