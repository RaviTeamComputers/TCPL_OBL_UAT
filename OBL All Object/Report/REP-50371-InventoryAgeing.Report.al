report 50371 "Inventory Ageing."
{
    ...
    dataset
    {
        dataitem("Item Ledger Entry"; "Item Ledger Entry")
        {
            ...
            begin
                ...
                CurrReport.CreateTotals(AmountDue[1], RemainingQty, Qty[1]);
                CurrReport.CreateTotals(AmountDue[2], RemainingQty, Qty[2]);
                CurrReport.CreateTotals(AmountDue[3], RemainingQty, Qty[3]);
                CurrReport.CreateTotals(AmountDue[4], RemainingQty, Qty[4]);
                CurrReport.CreateTotals(AmountDue[5], RemainingQty, Qty[5]);
                CurrReport.CreateTotals(AmountDue[6], RemainingQty, Qty[6]);
                CurrReport.CreateTotals(AmountDue[7], RemainingQty, Qty[7]);
                CurrReport.CreateTotals(AmountDue[8], RemainingQty, Qty[8]);
                CurrReport.CreateTotals(AmountDue[9], RemainingQty, Qty[9]);
    ...
    begin
        ...
        ItemApplicationEntry.SETRANGE(ItemApplicationEntry."Posting Date", 0D, PeriodEndDate);//010190D
