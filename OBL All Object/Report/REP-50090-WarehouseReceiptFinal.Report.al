...
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayouts\WarehouseReceiptFinalNew.rdl';
    ...
    dataset
    {
        dataitem("Item Ledger Entry"; "Item Ledger Entry")
        {
            ...
            column(CompInfoState; "Company Information"."State Code")
            {
            }
            ...
            begin
                ...
                T27Temp.Reset();
                T27Temp.SetRange("No. 2", "Item Ledger Entry"."Item No.");
                T27Temp.Setrange("Last Date Modified", "Item Ledger Entry"."Posting Date");
                T27Temp.SetRange("Item Disc. Group", DocNo);
                IF Not T27Temp.FindFirst() then begin
                    T27Temp.Init();
                    TableIncr += 1;
                    T27Temp."No." := Format(TableIncr);
                    T27Temp."No. 2" := "Item Ledger Entry"."Item No.";
                    T27Temp."Last Date Modified" := "Item Ledger Entry"."Posting Date";
                    T27Temp."Item Disc. Group" := DocNo;
                    T27Temp."Profit %" := TransQuantityCR;
                    T27Temp."Unit Cost" := TransQuantitySQ;
                    T27Temp.Insert();
    ...
    trigger OnPreReport()
    begin
        REPORT.RUNMODAL(50216, FALSE, FALSE, "Item Ledger Entry");
