        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Sales Invoice Header"; "Sales Invoice Header")
            {
                ...
                dataitem("Sales Invoice Line"; "Sales Invoice Line")
                {
                    ...
                    column(TotalDis1; TotalDis1) //17141
                    { }

                    column(Trad_discount; Round("Sales Invoice Line"."Trade Discount Amount", 0.01, '='))   //17141
                    {
                    }
                    ...
                    column(Insurance1; ROUND("Sales Invoice Header"."Insurance Amount", 0.01))  //17141
                    {
                    }
