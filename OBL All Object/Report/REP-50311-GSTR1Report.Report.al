        ...
        IF DetailedGSTLedgerEntryExcel.FINDFIRST THEN
            REPEAT
                IF (DocNoB2B <> DetailedGSTLedgerEntryExcel."Document No.") OR (DocLnNoB2B <> DetailedGSTLedgerEntryExcel."Document Line No.") THEN BEGIN
                                      ...
                                      (DetGSTLE."GST on Advance Payment" = TRUE) THEN BEGIN
                                        CASE DetGSTLE."GST Component Code" OF
                                            ...
                                            'UGST':
                                                ...
                                                END;
                                        END;
                                        // 16630 AdvAdjustedAmt := TotalAmt / TotalAmt1;
                    ...
                    TempExcelBuffer.AddColumn(SrNo1, FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Number);//15578T
                    ...
                    //16630  TempExcelBuffer.AddColumn(FORMAT(DetailedGSTLedgerEntryExcel."Nature of Supply"), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);Blank
                    ...
                    //16630  TempExcelBuffer.AddColumn(FORMAT(DetailedGSTLedgerEntryExcel."Buyer/Seller State Code"), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);
                    TempExcelBuffer.AddColumn(FORMAT(''), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);
                    ...
                    // 16630  TempExcelBuffer.AddColumn(Abs(TotalAmt / TotalAmt1), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Number);
                    TempExcelBuffer.AddColumn(Abs(TotalAmt), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Number);//Change
                                                                                                                                      //16630 TempExcelBuffer.AddColumn(ABS(DetailedGSTLedgerEntryExcel."Amount to Customer/Vendor"),FALSE,'',FALSE,FALSE,FALSE,'',TempExcelBuffer."Cell Type"::Number);//In Header Colume CGST Value
                                                                                                                                      //  TempExcelBuffer.AddColumn(Abs(CGSTRate), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Number);////In Header Colume CGST Value
                    ...
                    //16630   TempExcelBuffer.AddColumn(DetailedGSTLedgerEntryExcel."Amount to Customer/Vendor", FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Number);
                    TempExcelBuffer.AddColumn(Abs(TotalAmt), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Number);
