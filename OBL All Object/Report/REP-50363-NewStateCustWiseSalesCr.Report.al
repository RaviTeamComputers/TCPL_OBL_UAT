report 50363 "New State Cust. Wise Sales Cr."
{
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                column(Insurance1; Insurance1)//Insurance1
                {
                }
                column(NetValue; NetValue)//NetValue
                {
                }
                ...
                column(MRPPrice; "Sales Cr.Memo Line"."MRP Price")
                {
                }
                ...
                var
                    ...
                    SCML1: Record "Sales Cr.Memo Line";
                ...
                begin
                    ...
                    Clear(Insurance2);
                    SCML.Reset();
                    SCML.SetRange("Document No.", "Sales Cr.Memo Header"."No.");
                    SCML.SetRange(Type, SCML.Type::"Charge (Item)");
                    SCML.SetFilter("No.", '%1', 'INSURANCE');
                    if SCML.FindSet() then
                        Insurance2 := SCML."Line Amount";


                    DetailedGSTLedgerEntryL.RESET;
                    DetailedGSTLedgerEntryL.SetRange(Type, DetailedGSTLedgerEntryL.Type::"Charge (Item)");
                    DetailedGSTLedgerEntryL.SETRANGE("Document No.", "Document No.");
                    DetailedGSTLedgerEntryL.SETRANGE("No.", "No.");
                    DetailedGSTLedgerEntryL.SETRANGE("Document Line No.", "Line No.");

                    IF DetailedGSTLedgerEntry.FindFirst() THEN
                        INGSTAMt := DetailedGSTLedgerEntryL."GST Amount";
                    ...
                    //InvDisc1 := "Sales Cr.Memo Header"."Trade Discount" + "Sales Cr.Memo Header"."Discount Amount";
                    InvDisc1 := "Sales Cr.Memo Line"."Inv. Discount Amount";
                    ...
                    IF DetailedGSTLedgerEntry.FINDFIRST THEN
                        REPEAT
                            ...
                            IF DetailedGSTLedgerEntry."GST Component Code" = 'UTGST' THEN BEGIN
                                ...
                                UAmount1 += UAmount;
                            END;
                            TotalGSTAmt := CAmount1 + sAmount1 + IAmount1 + UAmount1 + INGSTAMt;
                        // TotalGSTAmt := ((SalesValue + Insurance2) * GSTPERCENT("Document No.", "Line No.") / 100);

                        UNTIL DetailedGSTLedgerEntry.NEXT = 0;
                    NetValue := ROUND(SalesValue + TotalGSTAmt + ET1, 0.01, '=');//15578
    ...
    var
        ...
        Insurance2: Decimal;
        RoundOff2: Decimal;
        DetailedGSTLedgerEntryG: Record "Detailed GST Ledger Entry";



    procedure GSTPERCENT(DocNo: Code[20]; DocLineNo: Integer): Decimal
    var
        PostSalCrMe: Record "Sales Cr.Memo Line";
        TotalAmt: Decimal;
