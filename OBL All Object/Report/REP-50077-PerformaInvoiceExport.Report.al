report 50077 "Performa Invoice Export"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayouts\PerformaInvoiceExport2.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; 36)
        {
            ...
            column(BenAdd; BenAdd)
            {
            }
            column(RoundPrec; RoundPrec)
            {

            }
            column(RouDir; RouDir)
            {
            ...
            column(ARNNoDt; ARNNoDt)
            {
            }
            column(PartialShipment; PartialShipment)
            {
            }
            column(DescriptionofGoods; DescriptionofGoods)
            {
            }
            column(HarmonicCode; HarmonicCode)
            {
            }
            column(PortofCustomEntry; PortofCustomEntry)
            {
            }
            ...
            column(BILL_CITY_POST; BillToAdd[4])
            {
            }
            column(BILL_STATE; BillToAdd[9])
            {
            }
            column(EximCode; 0) // 16630 blank CustRec.E.C.C. No.
            {
            }
            ...
            column(BILL_Mobile; BillToAdd[12])
            {
            }
            column(BILL_Email; BillToAdd[13])
            {
            }
            ...
            column(BankADCode; BankDetail[8])
            {
            }
            column(PostCodeCity; CustRec."Post Code" + ', ' + CustRec.City)
            {
            }
            ...
            column(TradeDiscount_SalesInvoiceHeader; "Sales Header"."Trade Discount")
            {
            }
            column(Discount_Amount; ABS("Sales Header"."Discount Amount"))
            {

            }

            column(Location_Address; Location.Address + ',' + Location."Address 2" + ', ' + Location.City + ',' + State_Rec.Description + ', ' + 'INDIA')
            {
            }
            ...
            dataitem(CopyLoop; 2000000026)
            {
                ...
                dataitem("Sales Line"; "Sales Line")
                {
                    ...
                    column(TDSTCS_SalesInvoiceLine; TCSper) // 16630 blank TDS/TCS %
                    {
                    }
                    column(TotalTDSTCSInclSHECESS_SalesInvoiceLine; TotalTCSShecessAmt) // 16630 blank Total TDS/TCS Incl. SHE CESS
                    {
                    }
                    ...
                    column(Description2; "Sales Line".Description + ' ' + "Sales Line"."Description 2")
                    {
                    }
                    ...
                    column(MRP; "Sales Line"."MRP Price") // 16630 blank replace MRP Price
                    {
                    }
                    ...
                    column(Disamt; CashDis)
                    {
                    }
                    column(LineDisAmt; "Sales Line"."Line Discount Amount")
                    {
                    }
                    ...
                    column(FrightChargeAmt; Abs(FrightChargeAmt))
                    {
                    }
                    column(InsurenceChargeAmount; "Sales Header"."Insurance Amount")
                    {
                    }
                    ...
                    begin
                        ...
                        if SL.FindSet() then
                            repeat
                                //CashDis += SL."Line Amount";
                                if (SL."Trade Discount Amount" <> 0) then
                                    CashDis += ABS(SL."Inv. Discount Amount" - SL."Trade Discount Amount")
                                else
                                    CashDis += SL."Inv. Discount Amount";
                        ...
                        SL.SetRange("No.", '%1', 'Freight Outward');
                        if SL.FindSet() then
                            FrightChargeAmt := SL."Line Amount";
                        ...
                        TotalAmount += "Line Amount" + igst + cgst + sgst; // 16630



                        TotalNoOfInvoiceLines := "Sales Line".COUNT();

                        /* 16630 IF "Sales Line"."GST %" = 0.5 THEN
                            GST05 := 'abc'
                        ELSE
                            GST05 := '';*/ // 16630
                        ...
                        /* 
                                                ...
                                                //MESSAGE('Item No=%1,Size = %2',"Sales Line"."No.",RecItem."Size Code Desc.");
                                                ...
                                                IF DetailedGSTLedgerEntry.FINDFIRST THEN
                                                    ...
                                                    UNTIL
                        DetailedGSTLedgerEntry.NEXT = 0;16630 */
                        //MIPLRK210422>>>
                        /*
                        Sno +=1 ;
                        ...
                        */
                        ...
                        // FrightChargeAmt := 0;
                        ChargeDisAmt := 0;
                        //16630CLEAR(InsurenceChargeAmount);
                        ...
                        IF SalesInvoiceLine1.FIND('-') THEN BEGIN
                            TotalBed := TotalBed +
                                ...
                                "Sales Header"."Posting Date", "Sales Header"."Currency Code",
                                  SalesInvoiceLine1.Amount, "Sales Header"."Currency Factor"),// 16630 SalesInvoiceLine1."BED Amount" replace by Amount
                            ...
                            TotalEcess := TotalEcess +
                                ...
                                CurrExchRate.ExchangeAmtFCYToLCY(
                                "Sales Header"."Posting Date", "Sales Header"."Currency Code",
                                  SalesInvoiceLine1.Amount, "Sales Header"."Currency Factor"),// 16630 SalesInvoiceLine1."eCess Amount" replace by amount
                                  Currency."Unit-Amount Rounding Precision");
                            ...
                            TotalShcess := TotalShcess +
                                ...
                                CurrExchRate.ExchangeAmtFCYToLCY(
                                "Sales Header"."Posting Date", "Sales Header"."Currency Code",
                                  SalesInvoiceLine1.Amount, "Sales Header"."Currency Factor"),// 16630 SalesInvoiceLine1."SHE Cess Amount" replace by amount
                                  Currency."Unit-Amount Rounding Precision");
                        ...
                        //MSSS
                        /* 16630 ExcisePostingSetup.SETRANGE("Excise Bus. Posting Group", "Excise Bus. Posting Group");
                        ...
                        IF Quantity <> 0 THEN
                            //16630 BuyersPrice := (Amount + "Excise Amount") / Quantity;
                            BuyersPrice := "Sales Line"."Buyer's Price /Sq.Mt";
                        ...
                        //Value := ROUND(((BuyersRatePerSqMtr - DiscPerCart) * "Quantity in Sq. Mt."),0.01,'>');  //MIPLRK100822
                        //Value := ROUND(((BuyersRatePerSqMtr) * "Quantity in Sq. Mt."),0.01,'>');  //MIPLRK100822
                        //MIPLRK260822>>>>
                        IF Currency.GET("Sales Line"."Currency Code") THEN;
                        Value := ROUND("Sales Line".Quantity * "Sales Line"."Unit Price", Currency."Amount Rounding Precision");
                        //MIPLRK260822<<<<

                        /* 16630 IF Quantity <> 0 THEN BEGIN
                        ...
                        Discount := 0;
                        /* 16630 PostedStrOrderLDetails.RESET;
                        ...
                        // 16630 AssesableVal := "Sales Line"."Assessable Value" * "Sales Line".Quantity;
                        // 16630  IF ExciseProdPostingGroup.GET("Sales Line"."Excise Prod. Posting Group") THEN;
            ...
            begin
                ...
                ELSE
                    IF "Sales Header"."Location Code" = 'DRA-WH-MFG' THEN
                        ARNNoDt := ArnDoraMorbi
                    ELSE
                        IF "Sales Header"."Location Code" = 'DP-MORBI' THEN
                            ARNNoDt := ArnDoraMorbi
                        ELSE
                            ARNNoDt := '';

                LCDetailforExport.RESET;
                LCDetailforExport.SETRANGE("Sales Order", "Sales Header"."No.");
                IF LCDetailforExport.FINDFIRST THEN BEGIN
                    Tolerance := LCDetailforExport.Tolerance;
                    PostofLoading := LCDetailforExport."Port of Loading";
                    PostofDischarge := LCDetailforExport."Port of Discharge";
                    Origin := LCDetailforExport.Origin;
                    PartialShipment := LCDetailforExport."Partial & Trans Shipment";
                    DescriptionofGoods := LCDetailforExport."Discription of Goods";
                    HarmonicCode := LCDetailforExport.Harmonic;
                    PortofCustomEntry := LCDetailforExport."Post of Discharge";
                    //MESSAGE('Hi');
                END;
                ...
                BEGIN
                    ...
                    BillToAdd[12] := CustRec."Mobile No.";
                    BillToAdd[13] := CustRec."E-Mail";
                ...
                LCDetailforExport1.RESET;
                LCDetailforExport1.SETRANGE("Sales Order", "Sales Header"."No.");
                IF LCDetailforExport1.FINDFIRST THEN BEGIN
                    CLEAR(BankDetail);
                    BankInfo.RESET;
                    BankInfo.SETRANGE("No.", LCDetailforExport1."Exporter Bank Detail");
...
RecState.NEXT = 0;
                ...
                /*    State1.RESET;
                   State1.SETRANGE(State1.Code, "Sales Line"."State Name"); // 16630 Replace State by state name
                   IF State1.FIND('-') THEN
                       Stname := State1.Description;
    */
                j := 0;
                ...
                IF SalesInvLine5.FIND('-') THEN BEGIN
                    ...
                    IF TaxAreaLine.FIND('-') THEN
                        REPEAT
                            ...
                            // 16630 TaxDetails.SETFILTER(TaxDetails."Form Code", '%1', "Sales Header"."Form Code");
                ...
                */
                ...
                /* 16630 IF "Sales Header"."Form Code" <> '' THEN
                ...
                FormatAddr.SalesHeaderBillTo(BillToAddr, "Sales Header");  //Rk160222
                                                                           // 16630 FormatAddr.SalesHeaderShipTo(ShipToAddr, "Sales Header");  //Rk160222
                ...
                /* 16630 PostedDocDim1.SETRANGE("Table ID", DATABASE::"Sales Header");
                 PostedDocDim1.SETRANGE("Document No.", "Sales Header"."No.");*/ // 16630
                ...
                IF Customer.FIND('-') THEN BEGIN
                    /* 16630 CustECCNo := Customer."E.C.C. No.";
                ...
                IF SIL.FIND('-') THEN BEGIN
                    REPEAT
                        ...
                        if ReccSalesLine.FindSet() then
                            ...
                            until ReccSalesLine.Next() = 0;
                        GrandTotal += "Line Amount" + igst + cgst + sgst;
                        // IF SIL."No." = '51157000' THEN
                        GLRoundingOFF += "Line Amount" + igst + cgst + sgst; // 16630


                    // 16630 TraiffNo := SIL."Excise Prod. Posting Group";
                    /*   GrandTotal += SIL."Amount To Customer";

                             GLRoundingOFF += SIL."Amount To Customer";  */ // 16630
                    UNTIL SIL.NEXT = 0;
                END;
    ...
    var
        ...
        // 16630 PostedStrOrderLineDetails: Record 13795;
        ...
        BenAdd: Label 'Benificiary Add: Orient Bell Ltd., IRIS House, 16 Business Centre, Nangal Raya, New Delhi-110046';
        LCDetailforExport1: Record "LC Detail for Export";
        ArnSKD: Label 'AD0903230523086 Date. 31.03.2023';//'AD0903220365737 Date. 31.03.2022';
        ArnDoraMorbi: Label 'AD2403230447078  Date. 31.03.2023';//'AD240322038871B  Date. 31.03.2022';
        ARNNoDt: Text[200];
    ...
    /*  local procedure TDSTCSPer(salesLine: Record "Sales Line"): Decimal
     var
