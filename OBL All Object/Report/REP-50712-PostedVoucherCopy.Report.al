report 50712 "Posted Voucher Copy"
{
    ...
    dataset
    {
        dataitem("G/L Entry"; 17)
        {
            ...
            column(Narration_LineNarration; "G/L Entry"."Line Narration")
            {
            }
            column(Narration_PostedNarration1; "G/L Entry".Narration_OT)
            {
            }
            ...
            begin
                ...
                //
                IF LocationRec.GET("G/L Entry"."Global Dimension 1 Code") THEN BEGIN
                    ...
                    LocationAddress[5] := "G/L Entry"."Global Dimension 1 Code";
                END;
            end;
    ...
    var
        ...
        GLentryLocation: Record "G/L Entry";
