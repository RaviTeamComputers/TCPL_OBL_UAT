    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            dataitem("Sales Invoice Header"; "Sales Invoice Header")
            {
                ...
                column(trad_disc; "Sales Invoice Header"."Trade Discount")
                {
                }
                column(gstrn; gstn)
                {
                ...
                dataitem("Sales Invoice Line"; "Sales Invoice Line")
                {
                    ...
                    column(Value; ("Sales Invoice Line"."Quantity in Sq. Mt." * Round(RoundValue, 0.1, '=')))
                    {
                    }
                    ...
                    column(SalesValue; ("Sales Invoice Line"."Quantity in Sq. Mt." * Round(RoundValue, 0.1, '=') - (InvDisc1 + "Sales Invoice Line"."Trade Discount Amount")))
                    {
                    }
                    ...
                    column(InsuranceClm; InsuranceClm) //InsuranceClm
                    {
                    }
                    ...
                    /* column(InvDisc2; InvDisc)
                    {

                    } */
                    column(Trad_discount; "Sales Invoice Line"."Trade Discount Amount")
                    ...
                    begin
                        ...
                        Clear(InvDisc);
                        Clear(Trad_discount);
                        ExAmount := "Sales Invoice Line".Amount;
                        ...
                        //TRI DG Add Stop
                        /*  IF "Quantity in Sq. Mt." <> 0 THEN BEGIN //16767
                         ...
                         DiscPerCart := "Line Discount Amount" / SqMt;//16767
  */

                        Value := (BuyersRatePerSqMtr - DiscPerCart) * "Quantity in Sq. Mt."; //16767
                        /*
                        ...
                        */
                        ...
                        //TotalValue := SalesValue + "Tax Amount" + Insurance1+VATAmount + ET1 + tgVATCess ;
                        //16625 TotalValue := SalesValue + Insurance1 + ET1; // 16767 + "Tax Amount"
                        // TRI SC
                        IF RecState.GET("Sales Invoice Header".State) THEN;

                        NetValue := ROUND(TotalValue, 1, '=');
                        //16767 Roundoff := ROUND(TotalValue, 1, '=') - TotalValue;
