report 50207 "Credit Memo"
{
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem("Sales Cr.Memo Line"; 115)
            {
                ...
                column(TotalTDSTCSInclSHECESS_SalesCrMemoLine; TotalTDS)
                {
                }
                ...
                column(NetAmtInWords; NetAmtInWords)
                {
                ...
                begin
                    ...
                    NetAmtInWords := TotalGSTAmtLine("Document No.");
                    NetAmt := TotalLineAmt + NetAmtInWords - TotalTDS;
            ...
            /*  dataitem(DataItem1000000002; Table13798)
              ...
              begin
                  ...
                  CustLedEntry.SETRANGE(CustLedEntry."DFINDFIRST THEN;
                  ...
                  IF Location2.GET("Sales Cr.Memo Header"."Location Code") THEN BEGIN
                      ...
                      IF State2.FINDFIRSTocument No.", "Sales Cr.Memo Header"."Applies-to Doc. No.");
                  IF CustLedEntry. THEN
    ...
    var
        PstdSalesInv: Record "Sales Cr.Memo Line";
        TotalAmt: Decimal;
