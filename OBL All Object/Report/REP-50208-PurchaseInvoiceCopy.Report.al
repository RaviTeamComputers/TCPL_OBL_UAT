report 50208 "Purchase - Invoice Copy"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Purch. Inv. Header"; 122)
        {
                ...
                dataitem(PageLoop; 2000000026)
                {
                    ...
                    dataitem("Purch. Inv. Line"; 123)
                    {
                        ...
                        begin
                            ...
                            GSTBaseAmt := 0;
                            TotalAmt := 0;
                            TotalTDSIncAmt := 0; //17699
                            IF (TotalTDSIncAmtCheck = false) then begin  //17699
                                TDSEntry.Reset();
                                TDSEntry.SetRange("Document No.", "Document No.");
                                if TDSEntry.FindSet() then
                                    repeat
                                        TotalTDSIncAmt += TDSEntry."Total TDS Including SHE CESS";
                                        TotalTDSIncAmtCheck := true;  //17699
                            ...
                            /*  RecDGLE.RESET();
                             ...
                             //RecDGLE.SetRange("No.", "Purch. Inv. Line"."No.");
                             RecDGLE.SetRange("Document Line No.", "Purch. Inv. Line"."Line No.");
                             IF RecDGLE.FindSet() THEN begin
                                 REPEAT
                                     if RecDGLE."GST Component Code" = 'IGST' then
                                         IGSTAmt += abs(RecDGLE."GST Amount");

                                     if RecDGLE."GST Component Code" = 'SGST' then
                                         SGSTAmt += abs(RecDGLE."GST Amount");

                                     if RecDGLE."GST Component Code" = 'CGST' then
                            ...
                            TotalAmt += "Line Amount" + IAmount + CAmount + SAmount + UAmount;
                            ...
                            TotalAmountInclVAT += TotalAmt - TotalTDSIncAmt;  // 16630 "Amount To Vendor"
            ...
            begin
                ...
                Clear(TotalTDSIncAmtCheck);  //17699
                CompanyInfo.GET;
    ...
    var
        ...
        TotalTDSIncAmtCheck: Boolean;  //17699
