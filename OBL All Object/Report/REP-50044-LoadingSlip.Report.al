            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        column(SUMQtySqmt; "Sales Line"."Reserved Qty. (Base)")
                        {
                        ...
                        column(Quantity_SalesLine; SalesQty)
                        {
                        }
                        ...
                        dataitem("Warehouse Inv Manement"; "Warehouse Inv Manement")
                        {
                            ...
                            */
                            ...
                            var
                                WIM_Rec: Record "Warehouse Inv Manement";
                            begin
                                // //>>17699
                                // Clear(InvtQty);
                                // WIM_Rec.Reset();
                                // WIM_Rec.SetRange("item Code", "Sales Line"."No.");
                                // WIM_Rec.SetRange(Location, "Sales Line"."Location Code");
                                // WIM_Rec.SetFilter("Loading Qty", '<>%1', 0);
                                // if WIM_Rec.FindSet() then begin
                                //     repeat
                                //         InvtQty += WIM_Rec.Qty;
                                //     until WIM_Rec.Next() = 0;
                                // end;
                                // //<<17699
