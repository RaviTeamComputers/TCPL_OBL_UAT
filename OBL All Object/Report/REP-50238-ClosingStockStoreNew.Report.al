report 50238 "Closing Stock - Store New"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = '.\ReportLayouts\ClosingStockStoreNew.rdl';
    PreviewMode = Normal;
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            begin
                ...
                //17144       CurrReport.CREATETOTALS(ToTqtyInSqm);
                InventorySetup.GET;
                ...
                QtyInSqm := "Net Change";
                //>>
                IF (QtyInCrt = 0) and (Item."Base Unit of Measure" = 'SQ.MT') and (QtyInSqm <= 0.5) then
                    QtyInSqm := 0;
                //<<
