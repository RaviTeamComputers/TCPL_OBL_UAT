report 50330 "Excise Details"
{
    ...
    dataset
    {
        dataitem("Dimension Value"; "Dimension Value")
        {
            ...
            column(TotOtherQuantity; 0)//Not In Use // TotOtherQuantity
            {
            }
                ...
                IF SaleInvLine.FINDFIRST THEN
                    REPEAT
                        IF SaleInvLine."Quality Code" = '1' THEN BEGIN
                            ...
                            PremAssessableValue += SaleInvLine."Line Amount";
                            TotPremAssessableValue += SaleInvLine."Line Amount";
                        ...
                        IF SaleInvLine."Quality Code" = '2' THEN BEGIN
                            ...
                            END;
                            //16225 field N/F Start
                            ComAssessableValue += SaleInvLine."Line Amount";
                            TotComAssessableValue += SaleInvLine."Line Amount";
                        ...
                        IF SaleInvLine."Quality Code" = '3' THEN BEGIN
                            ...
                            END;
                            //16225 field N/F Start
                            EcoAssessableValue += SaleInvLine."Line Amount";
                            TotEcoAssessableValue += SaleInvLine."Line Amount";
                        ...
                        IF SaleInvLine."Quality Code" = '' THEN BEGIN
                            ...
                            END;
                            //16225 field N/F Start
                            OtherAssessableValue += SaleInvLine."Line Amount";
                            TotOtherAssessableValue += SaleInvLine."Line Amount";
                ...
                IF TransfershipLine.FINDFIRST THEN
                    REPEAT
                        ...
                        IF TransfershipLine."Quality Code" = '1' THEN BEGIN
                            ...
                            PremAssessableValue += TransfershipLine.Amount;// 16630 Change Assessable Value to Amount
                            ...
                            //16225 field N/F Start
                            TotPremAssessableValue += TransfershipLine.Amount;
                        ...
                        IF TransfershipLine."Quality Code" = '2' THEN BEGIN
                            ...
                            //16225 field N/F Start
                            ComAssessableValue += TransfershipLine.Amount;
                            TotComQuantity += TransfershipLine."Quantity (Base)";
                            TotComAssessableValue += TransfershipLine.Amount;
                        ...
                        IF TransfershipLine."Quality Code" = '3' THEN BEGIN
                            ...
                            //16225 field N/F Start
                            EcoAssessableValue += TransfershipLine.Amount;
                            TotEcoQuantity += TransfershipLine."Quantity (Base)";
                            TotEcoAssessableValue += TransfershipLine.Amount;
                        ...
                        IF TransfershipLine."Quality Code" = '' THEN BEGIN
                            ...
                            //16225 field N/F Start
                            OtherAssessableValue += TransfershipLine.Amount;
                            TotOtherQuantity += TransfershipLine."Quantity (Base)";
                            TotOtherAssessableValue += TransfershipLine.Amount;
                ...
                IF CrMemoLine.FINDFIRST THEN
                    REPEAT
                        IF CrMemoLine."Quality Code" = '1' THEN BEGIN
                            ...
                            //16225 field N/F Start
                            PremAssessableValue += -(CrMemoLine."Line Amount");
                            TotPremAssessableValue += -(CrMemoLine."Line Amount");
                        ...
                        IF CrMemoLine."Quality Code" = '2' THEN BEGIN
                            ...
                            //16225 field N/F Start
                            ComAssessableValue += -(CrMemoLine."Line Amount");
                            TotComQuantity += -CrMemoLine."Quantity (Base)";
                            TotComAssessableValue += -(CrMemoLine."Line Amount");
                        ...
                        IF CrMemoLine."Quality Code" = '3' THEN BEGIN
                            ...
                            //16225 field N/F Start
                            EcoAssessableValue += -(CrMemoLine."Line Amount");
                            TotEcoQuantity += -CrMemoLine."Quantity (Base)";
                            TotEcoAssessableValue += -(CrMemoLine."Line Amount");
                        ...
                        IF CrMemoLine."Quality Code" = '' THEN BEGIN
                            ...
                            //16225 field N/F Start
                            OtherAssessableValue += -(CrMemoLine."Line Amount");
                            TotEcoQuantity += -CrMemoLine."Quantity (Base)";
                            TotEcoAssessableValue += -(CrMemoLine."Line Amount");
                            /*    EcoExciseAmount += -CrMemoLine."BED Amount";
                                //  EcoCess+=SaleInvLine."CESS Amount";
