report 50087 Check1111
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayouts\Check1111.rdl';
                    ...
                    begin
                        ...
                        IF NOT TestPrint THEN BEGIN
                            WITH GenJnlLine DO BEGIN
                                ...
                                // NAVIN
                                CheckLedgEntry.Description := Narration;
                                ...
                                IF FoundLast THEN BEGIN
                                    CheckAmountText := FORMAT(ABS(GenJnlLine.Amount) - TDSAmount - WorkTaxAmount, 0); // NAVIN //monika
                                    ...
                                    END;
                                    FormatNoText(DescriptionLine, (ABS(GenJnlLine.Amount) - TDSAmount - WorkTaxAmount), BankAcc2."Currency Code"); // NAVIN
                                    VoidText := '';
                                END ELSE BEGIN
                    ...
                    IF NOT TestPrint THEN BEGIN
                        ...
                        END ELSE BEGIN
                            ...
                            IF BalancingType <> BalancingType::"G/L Account" THEN
                                GenJnlLine3.Narration := STRSUBSTNO(Text014, SELECTSTR(BalancingType + 1, Text062), BalancingNo);
                ...
                IF NOT TestPrint THEN BEGIN
                   ...
                   */
                    IF ("Account No." <> '') THEN BEGIN
                        ...
                        // NAVIN
                        // 16630    TDSAmount := ABS("Total TDS/TCS Incl. SHE CESS");
                        // 16630   WorkTaxAmount := ABS("Work Tax Amount");
                        // NAVIN
    ...
    var
        ...
        CompanyAddr: array[8] of Text[65];
        CheckToAddr: array[8] of Text[260];
        ...
        Amt: array[500] of Text[500];//Change array Lenght 100 to 500
        Name: array[100] of Text[500];
        AmtText: array[100] of Text[650];
        Dt: array[100] of Text[500];
        NoText: array[2] of Text[100];
        CheqNo: Integer;
        No1: Integer;
        Flag: Boolean;
        AcPayee: array[2] of Code[50];
        a: Boolean;
        D: Integer;
        M: Integer;
        Y: Integer;
        ...
        AmtText1: array[100] of Text[600];
        CheckReport: Report "Check Report";
        SBI2Check: Boolean;
        BankAccNo: Code[30];
    ...
    begin
        ...
        IF (CurrencyCode <> '') THEN BEGIN
            ...
            AddToNoText1(NoText, NoTextIndex, PrintExponent, ' ' + Curr."Currency Numeric Description");
        END ELSE
    ...
    local procedure AddToNoText1(var NoText: array[2] of Text[100]; var NoTextIndex: Integer; var PrintExponent: Boolean; AddText: Text[30])
    begin
        PrintExponent := TRUE;
