    ...
    dataset
    {
        dataitem("Transfer Header"; 5740)
        {
            ...
            dataitem("Transfer Line"; 5741)
            {
                ...
                column(CRate; GSTper2)
                {
                }
                column(CAmount; cgst)
                {
                }
                column(SRate; GSTper3)
                {
                }
                column(SAmount; sgst)
                {
                }
                column(IRate; GSTper1)
                {
                }
                column(IAmount; igst)
                {
                ...
                begin
                    ...
                    /* DetailedGSTEntryBuffer.RESET;
                     ...
                     IF DetailedGSTEntryBuffer.FINDFIRST THEN
                         ...
                         UNTIL
 DetailedGSTEntryBuffer.NEXT = 0;16630 */
                    ...
                    TransferLine.SetRange("Line No.", "Transfer Line"."Line No."); //17699
                    if TransferLine.FindSet() then begin
                        TotalAmt := TransferLine.Amount;
    ...
    var
        ...
        GSTper2: Decimal;
        cgstTOTAL: Decimal;
        ReccSalesLine: Record "Transfer Line";
        TotalAmt: Decimal;
