codeunit 50006 IndentRelease
{
    ...
    begin
        ...
        IF (EmailTo <> '') OR (EmailCC <> '') THEN BEGIN
            ...
            CASE IndentHeader."Location Code" OF
                'SKD-STORE':
                    BEGIN
                        PlantHeadEmail := 'nitin.kharya@orientbell.com';
                ...
                'DRA-STORE':
                    BEGIN
                        PlantHeadEmail := 'nitin.kharya@orientbell.com';
                        PlantHeadEmail3 := 'ram.dutt@orientbell.com';
                    END;
                'HSK-STORE':
                    BEGIN
                        PlantHeadEmail := 'g.vaidyanathan@orientbell.com';
                        PlantHeadEmail4 := 'arvind.kumar@orientbell.com';
                    END;
            END;
    ...
    begin
        ...
        IF (EmailTo <> '') OR (EmailCC <> '') THEN BEGIN
            ...
            BodyText += (Text50041 + Text60012 + 'Rate' + Text60013 + Text60003);
            BodyText += (Text50041 + Text60012 + 'Amount' + Text60013 + Text60003);
            BodyText += (Text50041 + Text60012 + 'Stock' + Text60013 + Text60003); // 15578000
                ...
                REPEAT
                    IF PurchaseLine."No." <> '' THEN BEGIN//KEshav08062020
                        ...
                        IF HSKPrice = 0 THEN
                            hsklpdate := 0D;
                        //Keshav08062020
                        BodyText += (Text50041 + FORMAT(ROUND(CalculateMainLocationStock(PurchaseLine."No.", PurchaseHeader."Location Code"), 0.01, '=')) + Text60003);//15578T
