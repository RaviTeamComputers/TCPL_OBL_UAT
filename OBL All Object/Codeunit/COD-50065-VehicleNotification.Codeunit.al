codeunit 50065 "Vehicle Notification"
{
    ...
    begin
        ...
        EmailAddressList.Add(txtRecvEmailId);
        ...
        EmailMsg.Create(EmailAddressList, txtSubj, BodyText, true, EmailCCList, EmailBccList);
        IF EmailObj.Send(EmailMsg, Enum::"Email Scenario"::Notification) THEN BEGIN
            MESSAGE('Mail Send Successfully!');
        END
        ELSE
            MESSAGE('Mail Not Send Yet');
