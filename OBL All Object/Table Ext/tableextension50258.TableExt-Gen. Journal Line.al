tableextension 50258 tableextension50258 extends "Gen. Journal Line"
{
    ...
    begin
        rec."Beneficiary Account Type" := rec."Beneficiary Account Type"::Current;
...
*/
    ...
    */
    ...
    Begin
        ...
        TempGenJnlLine.SetFilter("Line No.", '<=%1', GenJnlLine."Line No.");
    ...
    begin
        ...
        GenJnlLine.SetFilter("PO No.", '%1', '');
        GenJnlLine.SETFILTER("TDS Section Code", '<>%1', '');
