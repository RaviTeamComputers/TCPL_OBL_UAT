tableextension 50131 tableextension50131 extends Customer
{
    fields
    {
        ...
        modify("GST Customer Type")//
        {
            ...
            trigger OnBeforeValidate()
            begin
                if (USERID = 'IT005') OR (USERID = 'ADMIN') then begin

                    if "GST Customer Type" = "GST Customer Type"::Export then begin
                        "state code New" := "State Code";
                        "State Code" := '';
                    end;
                end;
        ...
        field(50062; "Created By"; Code[20])
        {
        ...
        field(85006; "state code New"; Code[10])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    procedure CreateAsVendor(RecCust: Record Customer)
    var
        Vendor: Record Vendor;
        VendReq: Record "Vendor Requisition";
        Cont: Page "Contact Card";
    begin
        IF NOT Vendor.GET(recCust."No.") THEN begin
            Vendor.INIT;
            Vendor."No." := RecCust."No.";
            Vendor.Name := RecCust.Name;
            Vendor."Name 2" := RecCust."Name 2";
            Vendor.Address := RecCust.Address;
            Vendor."Address 2" := RecCust."Address 2";
            Vendor."Post Code" := RecCust."Post Code";
            Vendor.City := RecCust.City;
            Vendor."State Code" := RecCust."State Code";
            Vendor."Country/Region Code" := RecCust."Country/Region Code";
            Vendor."Gen. Bus. Posting Group" := 'DOMESTIC';
            Vendor."Vendor Posting Group" := 'CUST';
            Vendor."Pin Code" := RecCust."Pin Code";
            Vendor."Mobile Phone No." := RecCust."Mobile Phone No.";
            Vendor."Vendor Phone No." := RecCust."Phone No.";
            Vendor."P.A.N. No." := RecCust."P.A.N. No.";
            Vendor."GST Registration No." := RecCust."GST Registration No.";
            Vendor."Bank A/c" := RecCust."Bank Account No.";
            Vendor."Bank Account Name" := RecCust."Bank Account Name";
            Vendor."Bank Beneficiary Name" := RecCust."Bank Account Name";
            Vendor."Bank Address" := RecCust."Bank Other Details";
            Vendor.Zone := RecCust.Zone;

            Vendor."E-Mail" := RecCust."E-Mail";
            case
                 RecCust."GST Customer Type" of
            ...
            // Vendor."GST Vendor Type" := Vendor."GST Vendor Type"::Registered
            Vendor.INSERT;
            if not VendReq.GET(Vendor."No.") THEN begin
                VendReq.Init();
                VendReq.TransferFields(Vendor);
                VendReq."No. Series Code" := Vendor."No.";
                VendReq."Pin Code" := Vendor."Pin Code";
                VendReq."State Code" := Vendor."State Code";
                VendReq."Bank Beneficiary Name" := Vendor."Bank Account Name";
                VendReq."Bank Address" := Vendor."Bank Address";
                VendReq."Pin Code" := Vendor."Pin Code";
                VendReq."Phone No." := Vendor."Mobile Phone No.";
                VendReq."Vendor Phone No." := Vendor."Phone No.";
                VendReq."P.A.N. No." := Vendor."P.A.N. No.";
                VendReq."GST Registration No." := Vendor."GST Registration No.";
                VendReq.Insert();
            end;
        end;
    end;
