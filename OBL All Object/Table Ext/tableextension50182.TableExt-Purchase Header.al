    ...
    fields
    {
        ...
        modify("Buy-from Vendor No.")
        {
            ...
            begin
                ...
                "GST Input Service Distribution" := xrec."GST Input Service Distribution";
        ...
        modify("Posting Date")
        {
            ...
            begin
                // PurchaseLine2.RESET;
                // PurchaseLine2.SETCURRENTKEY("Document Type", PurchaseLine2."Document No.");
        ...
        modify("Location Code")
        {
            ...
            begin
                LocalLocation := Rec."Location Code"; //17699

                // 15578 LocalLocation := Rec."Location Code"; //17699
                        ...
                        REPEAT
                            IF UserSetup1.GET(UPPERCASE(USERID)) THEN
                                IF UserLocation.GET(UPPERCASE(USERID), UserSetup1.Location) THEN BEGIN
                                    IF Location1.GET(UserLocation."Location Code") THEN
                                        IF Location1."Main Location" = '' THEN
                                            IF NOT ("Document Type" = "Document Type"::Order) THEN//Keshav10042020//15578
                                                // VALIDATE("Location Code", UserLocation."Location Code");
                                                "Location Code" := UserLocation."Location Code";
                                END ELSE BEGIN
                                    IF Location1.GET(UserLocation."Location Code") THEN
                                        IF Location1."Main Location" = '' THEN
                                            IF NOT ("Document Type" = "Document Type"::Order) THEN//Keshav10042020
            ...
            var
                locationREC: Record 14;
                SalesLine_Loc: Record "Sales Line"; //17699     
            begin
                if "Location Code" <> '' then begin
                    ...
                    "GST Input Service Distribution" := locationREC."Input Service Distributor";
                end;
                //>>17699
                IF (LocalLocation <> '') and (xRec."Location Code" <> LocalLocation) and (Rec."Document Type" = Rec."Document Type"::Order) then begin
                    locationREC.Get(LocalLocation);
                    "Location State Code" := locationREC."State Code";
                    "Location GST Reg. No." := locationREC."GST Registration No.";
                    "Shortcut Dimension 1 Code" := locationREC."Location Dimension";
                    "GST Input Service Distribution" := locationREC."Input Service Distributor";

                    Rec."Location Code" := LocalLocation;
                    SalesLine_Loc.Reset();
                    SalesLine_Loc.SetRange("Document Type", Rec."Document Type"::Order);
                    SalesLine_Loc.SetRange("Document No.", Rec."No.");
                    SalesLine_Loc.SetFilter(Type, '<>%1', 0);
                    IF SalesLine_Loc.FindSet then
                        SalesLine_Loc.ModifyAll("Location Code", Rec."Location Code");
                end;
                //<<17699
            end;
        ...
        field(50032; "Capex No."; Code[22])
        {
            Description = 'Ori Ut';
            FieldClass = FlowField;
            CalcFormula = Lookup("Purchase Line"."Capex No." WHERE(Type = FILTER(Item), "Document No." = FIELD("No.")));
                    ...
                    IF UserSetup1.GET(UPPERCASE(USERID)) THEN
                        IF UserLocation.GET(UPPERCASE(USERID), UserSetup1.Location) THEN BEGIN
                            IF Location1.GET(UserLocation."Location Code") THEN
                                IF Location1."Main Location" = '' THEN
                                    VALIDATE("Location Code", UserLocation."Location Code");
                            //  "Location Code" := UserLocation."Location Code";//17699
                        END ELSE BEGIN
                            IF Location1.GET(UserLocation."Location Code") THEN
                                IF Location1."Main Location" = '' THEN
                                    VALIDATE("Location Code", UserLocation."Location Code");
