tableextension 50015 tableextension50015 extends "Salesperson/Purchaser"
{
    fields
    {
        ...
        {
            OptionCaption = ' ,PCH,Zone Manager,PSM,PAC,Zonal Heads,PACM';
            OptionMembers = " ",PCH,"Zone Manager",PSM,PAC,"Zonal Heads",PACM;
        ...
        field(80013; "Report Storage"; Blob)
        {
            DataClassification = ToBeClassified;
            Subtype = Bitmap;
        }
        field(80014; "50034 Report"; Blob)
        {
            DataClassification = ToBeClassified;
            Subtype = Bitmap;
        }
