tableextension 50147 tableextension50147 extends Item
{
    ...
    fields
    {
        ...
        field(60066; "Inventory New"; Decimal)// 16630 for use in stock report
        {
            ...
            CalcFormula = Sum("Item Ledger Entry"."Quantity" WHERE("Item No." = FIELD("No."),
                                                                  ...
                                                                  "Location Code" = FIELD("Location Filter"),
                                                                  "Posting Date" = field("Date Filter"),
                                                                   //   "Quality Code" = field("Quality Code"),
                                                                   //   "Plant Code" = field("Plant Code"),
                                                                   //   "Size Code" = field("Size Code")
                                                                   "Drop Shipment" = FIELD("Drop Shipment Filter"),
                                                                  "Variant Code" = FIELD("Variant Filter"),
        ...
        field(60067; "Net Change New"; Decimal)// 16630 for use in stock report
        {
            Caption = 'Net Change New';
            FieldClass = FlowField;
            Editable = false;
            CalcFormula = Sum("Item Ledger Entry".Quantity WHERE("Item No." = FIELD("No."),
                                                                  "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
    ...
    fieldgroups
    {
        ...
        addlast(dropdown; "Description 2", "Complete Description", "No.", Description)
        {
