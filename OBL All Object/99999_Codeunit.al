codeunit 99999 Function// 50006
{
    ...
    begin
        ...
        IF SlaesInv.GET(GenJournalLine."Document No.") THEN Begin
            GenJournalLine.VALIDATE("Shortcut Dimension 1 Code", SlaesInv."Shortcut Dimension 1 Code");
            GenJournalLine."Location Code" := SlaesInv."Location Code";
        End;
        IF PurchInv.GET(GenJournalLine."Document No.") THEN Begin
            GenJournalLine.VALIDATE("Shortcut Dimension 1 Code", PurchInv."Shortcut Dimension 1 Code");
            GenJournalLine."Location Code" := PurchInv."Location Code";
        End;
        IF TSH.GET(GenJournalLine."Document No.") THEN Begin
            GenJournalLine.VALIDATE("Shortcut Dimension 1 Code", TSH."Shortcut Dimension 1 Code");
            GenJournalLine."Location Code" := TSH."Transfer-from Code";
        End;
        IF TRH.GET(GenJournalLine."Document No.") THEN Begin
            GenJournalLine.VALIDATE("Shortcut Dimension 1 Code", TRH."Shortcut Dimension 1 Code");
            GenJournalLine."Location Code" := TRH."Transfer-to Code";
        End;
