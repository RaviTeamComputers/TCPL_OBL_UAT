pageextension 50011 pageextension50011 extends "User Setup"
{
    layout
    {
        ...
        addafter("Time Sheet Admin.")
        {
            ...
            //>>17699
            field("Edit Shelf No."; Rec."Edit Shelf No.")
            {
                ApplicationArea = All;
                Caption = 'Edit Shelf No.';
            }
            field("Edit Shelf Location HSK"; Rec."Edit Shelf Location HSK")
            {
                ApplicationArea = All;
                Caption = 'Edit Shelf Location HSK';
            }
            field("Edit Shelf Location Dra"; Rec."Edit Shelf Location Dra")
            {
                ApplicationArea = All;
                Caption = 'Edit Shelf Location Dra';
            }
