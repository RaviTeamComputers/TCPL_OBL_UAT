pageextension 50431 pageextension50431 extends "Purchase Order"
{
    layout
    {
        ...
        modify("Location Code")
        {
            ...
            begin
                ...
                IF UserLocation.FindSet() THEN
                    REPEAT
                        Location1.RESET;
                        Location1.SETFILTER(Location1.Code, UserLocation."Location Code");
                        Location1.SETFILTER(Location1."Main Location", '%1', '');
                        IF Location1.FindFirst() THEN
                            UserLocation.MARK(TRUE);
                    UNTIL UserLocation.NEXT = 0;
                UserLocation.MARKEDONLY(TRUE);
        ...
        movebefore("Approval Status"; Status, "Location Code")
        ...
        addafter("Order Date")
        {
            ...
            /*field("Vendor Shipment Date"; Rec."Vendor Shipment Date")//16225 table Field N/F
            {
            }*/
        ...
        moveafter("Delivary Date"; "Vendor Invoice No.", "Vendor Shipment No.", "Shipment Method Code", "Payment Terms Code")
        ...
        modify(Release)
        {
            ...
            begin
                ...
                IF PurchLine1.FIND('-') THEN
                    REPEAT
                        PurchLine1.TestField("TDS Section Code");
                        PurchLine1.TestField("GST Group Code");
                        PurchLine1.TestField("HSN/SAC Code");
        ...
        modify(SendApprovalRequest)
        {
            ...
            begin
                ...
                IF PurchaseLine3.FINDFIRST THEN
                    REPEAT
                        if PurchaseLine3.Type <> PurchaseLine3.Type::" " then BEGIN
                            PurchaseLine3.TestField("TDS Section Code");
                            PurchaseLine3.TestField("GST Group Code");
                            PurchaseLine3.TestField("HSN/SAC Code");
                        END;
