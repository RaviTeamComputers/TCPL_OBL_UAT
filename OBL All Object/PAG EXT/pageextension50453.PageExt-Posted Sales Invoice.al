pageextension 50453 "Posted Sales Invoice1" extends "Posted Sales Invoice"
{
    ...
    actions
    {
        addafter(Print)
        {
            ...
            action("GST Sales Invoice New")
            {
                Caption = 'GST Sales Invoice new';
                Enabled = true;
                Image = PrintVoucher;
                Promoted = true;
                PromotedCategory = Category4;
            ...
            action("Sales Debit Note")
            {
                ...
                begin
                    ...
                    SalesDebitNote.SETTABLEVIEW(SalesInvHeader);
    ...
    local procedure PrintReportNew()
    begin
        ...
        IF recCust."State Code" <> '19' THEN BEGIN
            ...
            IF recCustType.FINDFIRST THEN
                REPORT.RUN(50406, TRUE, FALSE, SalesInvHeader)
        END;
