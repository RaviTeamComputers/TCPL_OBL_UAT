        ...
        IF VendorRequisition.FINDFIRST THEN BEGIN
            ...
            END ELSE BEGIN
                ...
                IF Vendor.GET(VendorRequisition."No. Series Code") THEN BEGIN
                    ...
                    Case VendorRequisition."Aggregate Turnover" of
                        VendorRequisition."Aggregate Turnover"::"Less than 20 lakh":
                            Vendor."Aggregate Turnover" := Vendor."Aggregate Turnover"::"Less than 20 lakh";
                        VendorRequisition."Aggregate Turnover"::"More than 20 lakh":
                            Vendor."Aggregate Turnover" := Vendor."Aggregate Turnover"::"More than 20 lakh";
                    End;
                    // Case VendorRequisition."Vendor Class" of
                    //     VendorRequisition."Vendor Class"::" ":
                    //         Vendor."Vendor Classification" := VendorRequisition."Vendor Class";
                    //     VendorRequisition."Aggregate Turnover"::"More than 20 lakh":
                    //         Vendor."Aggregate Turnover" := Vendor."Aggregate Turnover"::"More than 20 lakh";
                    // End;

                    Case VendorRequisition."GST Vendor Type" of
                        VendorRequisition."GST Vendor Type"::" ":
                            Vendor."GST Vendor Type" := Vendor."GST Vendor Type"::" ";
                        VendorRequisition."GST Vendor Type"::Registered:
                            Vendor."GST Vendor Type" := Vendor."GST Vendor Type"::Registered;
                        VendorRequisition."GST Vendor Type"::Unregistered:
                            Vendor."GST Vendor Type" := Vendor."GST Vendor Type"::Unregistered;
                        VendorRequisition."GST Vendor Type"::Composite:
                            Vendor."GST Vendor Type" := Vendor."GST Vendor Type"::Composite;
                        VendorRequisition."GST Vendor Type"::SEZ:
                            Vendor."GST Vendor Type" := Vendor."GST Vendor Type"::SEZ;
                        VendorRequisition."GST Vendor Type"::Import:
                            Vendor."GST Vendor Type" := Vendor."GST Vendor Type"::Import;
                        VendorRequisition."GST Vendor Type"::Exempted:
                            Vendor."GST Vendor Type" := Vendor."GST Vendor Type"::Exempted;
                    end;
                    Vendor.Transporter := VendorRequisition.Transporter;
                    Vendor.Transporter1 := VendorRequisition.Transporter1;
                    Vendor."P.A.N. No." := VendorRequisition."P.A.N. No.";
                    Vendor."GST No." := VendorRequisition."GST No.";
                    Vendor."GST Registration No." := VendorRequisition."GST Registration No.";
                    Vendor."State Code" := VendorRequisition."State Code";
                    if VendorRequisition."P.A.N. Status" = VendorRequisition."P.A.N. Status"::PANNOTAVBL then
                        Vendor."P.A.N. No." := '';
