table 50099 "Attachment Management"
{
    ...
    begin
        ...
        if UploadIntoStream('', '', 'All Files (*.*)|*.*', FileName, InstreamL) then;
        ...
        Attachment.CreateOutStream(OutStreamL);
    ...
    begin
        ...
        Attachment.CreateInStream(InstreamL);
        DOWNLOADFROMSTREAM(InstreamL, 'Export', '', 'All Files (*.*)|*.*', "File Name");
    end;
