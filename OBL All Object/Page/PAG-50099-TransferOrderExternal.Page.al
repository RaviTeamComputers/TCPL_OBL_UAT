        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Truck No."; Rec."Truck No.")
                {
                    ...
                    begin
                        /* IF (Rec."Qty. To Ship" <> 0) AND (Rec."External Transfer") THEN
                            ERROR('Truck No. Cannot Changed When (Qty to Ship) is Greater Then ZERO'); *///15578
                    end;
                }
                ...
                field("GR No."; Rec."GR No.")
                {
                    ...
                    begin
                        /* IF (Rec."Qty. To Ship" <> 0) AND (Rec."External Transfer") THEN
                            ERROR('Gr.No. Cannot Changed When (Qty to Ship) is Greater Then ZERO'); *///15578
                    end;
                }
                field("GR Date"; Rec."GR Date")
                {
                    ...
                    begin
                        /* IF (Rec."Qty. To Ship" <> 0) AND (Rec."External Transfer") THEN
                            ERROR('Gr.Date Cannot Changed When (Qty to Ship) is Greater Then ZERO'); *///15578
                    end;
                }
