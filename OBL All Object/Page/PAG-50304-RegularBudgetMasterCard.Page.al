            ...
            group(control)
            {
                action("Approval Entries")
                {
                    ...
                    begin
                        ...
                        AppEntries.RESET;
                        AppEntries.SETFILTER("Table ID", '%1', Database::"Budget Master");
                        AppEntries.SETFILTER("Document No.", '%1', Rec."No.");
                        ApprovalEntries.SetTableView(AppEntries);
                ...
                action("Capex Project Report")
                {
                    ...
                    begin
                        ...
                        IF BudgetMaster.FINDFIRST THEN
                            REPORT.RUNMODAL(50085, TRUE, true, BudgetMaster);
                    end;
                }
                action(Attachments)
                {
